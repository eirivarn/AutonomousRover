...
class LineModule:
    ...
    def analyzeImage(self, image):
        ...
        x1, y1 = int(self.predict(self.const.resolution[1]/8)), int(self.const.resolution[1]/8)
        x0, y0 = int(self.predict(self.const.resolution[1]-self.const.resolution[1]/8)), int(self.const.resolution[1]-self.const.resolution[1]/8)
